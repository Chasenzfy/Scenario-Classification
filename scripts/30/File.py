...
class File:
    ...
    def my_back_home1(self):
        self.my_click_text("Internal Storage")
    ...
    def file_browse_0(self, move_list):
        ...
        for i in move_list:
            if i == -1:
                ...
                self.my_click_classname("android.widget.LinearLayout", 3 + 4 * i)
    ...
    def long_click_1(self, select_list=None):
        ...
        for i in select_list:
            if i == select_list[0]:
                self.my_long_click_classname("android.widget.LinearLayout", 3 + 4 * i)
            else:
                self.my_click_classname("android.widget.LinearLayout", 3 + 4 * i)
    ...
    def search_3(self, text=None):
        ...
        if text != None:
            self.my_edit_id("com.photovideotools.file.manager:id/search_src_text", text)
            self.my_back()
        self.my_back()
    ...
    # 可以修改的参数：删除是否成功还是不成功
    def music5(self, i):
        self.my_click_classname("android.widget.LinearLayout", 3 + i * 4)
    ...
    def new_folder_10(self, folder_name=None, is_success=None):
        ...
        :return:
        '''
        self.my_click_classname("android.widget.ImageButton", 2)
    ...
    def properties_browse_11(self):
        # 点击details按钮。
        self.my_click_accessibilty_id("Info")
    ...
    # 可以修改的参数：无
    def menu_13(self):
        self.my_click_accessibilty_id("Add")
    ...
    def settings_14(self):
        ...
        # theme style
        self.my_click_classname("android.widget.RelativeLayout", 0)
        self.my_click_classname("android.widget.CheckedTextView", 2)
