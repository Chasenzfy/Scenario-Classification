...
from SolidExplorerFileManager_14.SEFM import SolidExplorerFileManager
...
sefm = SolidExplorerFileManager(driver, screen_path, xml_path, jump_pairs, activity_info, True)
...
search('Android', [1, 1, 1, -1, -1, -1])
search('BatteryDog', [1, -1])
search('Download', [1, -1])
search('DCIM', [1, -1])
search('tmp', [1, -1])
search('Music', [1, -1])
