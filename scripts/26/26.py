...
class App:
    ...
    def launchable_14(self,action):
        ...
        if action == 0:
            #前往文件浏览
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.ListView/android.widget.LinearLayout[1]")
        #elif action == 6:
        #    #打开侧边栏
        #    self.my_click_accessibilty_id("Show navigation menu")
        elif action == 3:
            #搜索
            self.my_click_id("com.itel.filemanager:id/action_search")
        elif action == 18:
            #收藏
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.GridView/android.widget.LinearLayout[8]/android.widget.LinearLayout")
        else:
            assert False
    ...
    def file_browse_0(self, action, move_list=[]):
        ...
        if action == -1:
            ...
            self.my_click_id("com.itel.filemanager:id/action_sort")
        elif action == 1:
            ...
            self.my_click_id("com.itel.filemanager:id/action_new_folder")
        elif action == 14:
    ...
    def select_1(self,action):
        ...
        if action == 0:
            self.my_click_id("com.itel.filemanager:id/cancel")
        elif action == 7:
            self.my_click_id("com.itel.filemanager:id/action_delete")
        elif action == 13:
            self.my_click_id("com.itel.filemanager:id/action_more")
        elif action == 4:
            self.my_click_id("com.itel.filemanager:id/action_copy")
        elif action == -1:
            self.my_click_coordinates(539,1707)
        elif action == -2:
            self.my_click_id("com.itel.filemanager:id/select_all")
        else:
            assert False
    ...
    def delete_7(self,action):
        #action: false,true
        if action == False:
            self.my_click_id("com.itel.filemanager:id/bt_left")
        else:
            self.my_click_id("com.itel.filemanager:id/bt_right")

    #重命名
    def rename_12(self,action,new_name=""):
        #action: false,true
        self.my_clear_id("com.itel.filemanager:id/itel_editview_edittext")
        self.my_edit_id("com.itel.filemanager:id/itel_editview_edittext",new_name)
        if action == False:
            self.my_click_id("com.itel.filemanager:id/negative_btn")
        else:
            self.my_click_id("com.itel.filemanager:id/positive_btn")

    #待粘贴
    def to_paste_4(self,action,move_list=[],param1=[]):
        #action: false,true
        if action == False:
            self.my_click_id("com.itel.filemanager:id/button_paste_cancel")
        else:
            #/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]
            pointer = 0
            for element in move_list:
                if isinstance(element,int) == True:
                    ...
                    if element == -1:
                        ...
                        self.my_click_id("com.itel.filemanager:id/button_paste_confirm")
                    else:
                        self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[" + str(element) + ']')
                elif isinstance(element,str) == True:
                    #新建文件夹
                    self.my_click_id("com.itel.filemanager:id/action_create_folder")
                    self.my_clear_id("com.itel.filemanager:id/itel_editview_edittext")
                    self.my_edit_id("com.itel.filemanager:id/itel_editview_edittext",element)
    ...
    def new_folder_10(self,action,name=""):
        #action: false,true
        self.my_clear_id("com.itel.filemanager:id/itel_editview_edittext")
        self.my_edit_id("com.itel.filemanager:id/itel_editview_edittext",name)
        if action == False:
            self.my_click_id("com.itel.filemanager:id/negative_btn")
        else:
            self.my_click_id("com.itel.filemanager:id/positive_btn")
    ...
    def search_3(self,action,text=""):
        ...
        if action == 14:
            ...
            self.my_edit_id("com.itel.filemanager:id/search_src_text",text)
            self.my_press_code(66)
        elif action == -2:
            self.my_click_id("com.itel.filemanager:id/search_close_btn")
        #elif action == -2:
        ...
        #    self.my_long_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ListView/android.widget.LinearLayout[" + str(text) + ']')
            ...
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.ListView/android.widget.RelativeLayout[" + str(text) + ']')
        else:
            assert False
    ...
    #文件压缩
    def compress_2(self,action,name=None,password=None):
        if name != None:
            self.my_clear_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.EditText")
            self.my_edit_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.EditText",name)
        if password != None:
            self.my_clear_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.EditText")
            self.my_edit_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.EditText",password)
        if action == True:
            self.my_click_id("com.itel.filemanager:id/positive_btn")
        else:
            self.my_click_id("com.itel.filemanager:id/negative_btn")
...
if __name__ == '__main__':
    ...
    desired_caps['appPackage'] = 'com.itel.filemanager'
    desired_caps['appActivity'] = 'com.itel.filemanager.activity.MainActivity'
    ...
    app = App(driver, screen_path, xml_path, jump_pairs,activity_info,560)
    ...
    for name in name_list:
        ...
        app.compress_2(True,name + 'ti',name)
