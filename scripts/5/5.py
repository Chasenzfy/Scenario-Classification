...
class App:
    ...
    def launchable_14(self,action):
        ...
        if action == 6:
            ...
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/android.widget.FrameLayout[1]/android.widget.LinearLayout")
        else:
            assert False
    ...
    def file_browse_0(self, action, move_list=[]):
        ...
        if action == -1:
            ...
            if len(move_list) == 0:
                self.my_click_xpath('//android.widget.ImageView[@content-desc=\"More options\"]')
            else:
        ...
        #    self.my_click_text(move_list[0])
            ...
            self.my_click_id("dev.dworks.apps.anexplorer:id/menu_search")
        elif action == 6:
            self.my_click_accessibilty_id("Show roots")
        elif action == -2:
            self.my_click_id("dev.dworks.apps.anexplorer:id/fab")
        else:
            assert False
    ...
    def sidebar_6(self,action):
        ...
        if action == 14:
            #前往启动界面
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout[2]/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ExpandableListView/android.widget.LinearLayout[1]")
        #elif action == 0:
            #前往文件浏览
    ...
    def settings_17(self,action):
        ...
        if action == -2:
            ...
            #完成设置
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[1]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[2]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[3]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[4]")
            ...
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[2]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[3]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[3]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[4]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[4]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[5]")
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[5]")
            self.my_back()
    ...
    #点击menu
    def click_menu_13(self,action,mode=0):
        #action: ?-点击第几项
        if mode == 10:
            #新建文件/夹
            self.my_click_xpath("//android.widget.LinearLayout[@content-desc=\"Add\"]/android.widget.LinearLayout/android.widget.LinearLayout[" + str(action) + "]/android.widget.ImageButton")
        else:
    ...
    def select_1(self,action):
        ...
        if action == 0:
            self.my_click_id("dev.dworks.apps.anexplorer:id/action_mode_close_button")
        elif action == 11:
            self.my_click_id("dev.dworks.apps.anexplorer:id/menu_info")
        elif action == 13:
            self.my_click_id("dev.dworks.apps.anexplorer:id/menu_edit")
        elif action == 1:
            #全选
            self.my_click_id("dev.dworks.apps.anexplorer:id/menu_select_all")
        else:
            assert False
    ...
    #待粘贴
    def to_paste_4(self,action):
        #action: false,true
        if action == True:
            self.my_click_accessibilty_id("Paste")
        else:
            self.my_click_accessibilty_id("Cancel")
        '''
        if action == False:
            self.my_back()
        else:
    ...
    def search_3(self,action,text=""):
        ...
        #        0-点击文件
        if action == -1:
            self.my_clear_id("dev.dworks.apps.anexplorer:id/search_src_text")
            self.my_edit_id("dev.dworks.apps.anexplorer:id/search_src_text",text)
            self.my_press_code(66)
        elif action == -2:
            self.my_click_accessibilty_id("Collapse")
        elif action == 13:
            self.my_click_xpath("(//android.widget.TextView[@content-desc=\"‎‏‎‎‎‎‎‏‎‏‏‏‎‎‎‎‎‎‏‎‎‏‎‎‎‎‏‏‏‏‏‏‎‏‏‎‏‏‎‏‎‏‎‎‏‎‎‎‎‏‎‎‎‏‎‏‎‏‎‏‏‏‏‏‏‏‎‏‏‎‎‏‏‎‏‏‎‎‎‎‏‎‎‏‎‏‏‏‏‏‎‏‎‎‏‎More options‎‏‎‎‏‎\"])[" + str(text) + ']')
        elif action == 1:
            self.my_long_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/android.widget.FrameLayout[" + str(text) + ']')
        elif action == 0:
            self.my_click_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/android.widget.FrameLayout[" + str(text) + ']')
    ...
    def show_info_11(self,action=None):
        self.my_click_accessibilty_id("Hide roots")
...
if __name__ == '__main__':
    ...
    desired_caps['appPackage'] = 'dev.dworks.apps.anexplorer'
    ...
    app = App(driver, screen_path, xml_path, jump_pairs, activity_info, 620)
